 ...
 */
export function loadConfig<T extends BaseFrameworkConfig>(defaults: T, overrides?: Partial<T>): T {
  return {
    ...defaults,
    ...overrides,
  };
 ...
 */
export function validateModelConfig(models: Record<string, string>, requiredRoles: string[]): void {
