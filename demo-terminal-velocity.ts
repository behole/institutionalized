...
const work = {
  content: essay,
  context:
    'Essay about how cities destroy skatespots. EMB → LOVE → Pulaski pattern. Hub essay for (b)hole series. Already reviewed by critic panel (Didion, Talese, Kael, Thompson, Sontag) - got A- average, marked ready to publish.',
...
console.log(
  '\n📊 VERDICT:',
  result.instructorAssessment.readyToShip ? '✅ READY' : '❌ NEEDS REVISION'
);
