...
const fullEssay = readFileSync(
  '/Users/jjoosshhmbpm1/26/the-factory/01_Projects/bhole/content/drafts/terminal-velocity/hub-emb-v4.md',
  'utf-8'
);
...
const work = {
  ...
  context:
    "Opening sections of 'Terminal Velocity' - essay about EMB skateboard spot in SF. Full essay covers EMB→LOVE→Pulaski pattern showing how cities destroy skatespots.",
