...
const FRAMEWORKS = {
  ...
  courtroom: {
    name: 'courtroom',
    description:
      'Adversarial evaluation for binary decisions. Uses prosecutor, defense, jury, and judge to reach verdicts.',
    tier: 1,
    inputSchema: {
      type: 'object',
      properties: {
        ...
        evidence: {
          type: 'array',
          items: { type: 'string' },
          description: 'Evidence for consideration',
        },
  ...
  'peer-review': {
    name: 'peer-review',
    description:
      'Academic-style validation with author rebuttal. Multiple reviewers critique, author responds, editor synthesizes.',
    tier: 1,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  'red-blue': {
    name: 'red-blue',
    description:
      'Military stress-testing for security and architecture. Blue team proposes, red team attacks, observer synthesizes vulnerabilities.',
    tier: 1,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  'pre-mortem': {
    name: 'pre-mortem',
    description:
      'Identify failure modes before committing. Pessimists imagine ways things could fail, facilitator synthesizes risks.',
    tier: 1,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  studio: {
    name: 'studio',
    description:
      'Creative work evaluation with peer feedback. Silent observation, structured critique, creator response, instructor synthesis.',
    tier: 1,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  'devils-advocate': {
    ...
    description:
      'Formal challenge to proposals. Opposition attacks, proposer rebuts, arbiter decides.',
    tier: 2,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  aar: {
    name: 'aar',
    description:
      'After-Action Review for blameless learning from execution. Analyzes what happened vs. expected.',
    tier: 2,
    inputSchema: {
      type: 'object',
      properties: {
        ...
        intended: {
          type: 'array',
          items: { type: 'string' },
          description: 'What was intended to happen',
        },
  ...
  'six-hats': {
    name: 'six-hats',
    description:
      "Multi-perspective analysis using Edward de Bono's method. Six thinking hats examine from different angles.",
    tier: 2,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  'phd-defense': {
    name: 'phd-defense',
    description:
      'Rigorous proposal validation through doctoral examination. Committee members probe deeply.',
    tier: 2,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  'architecture-review': {
    ...
    description:
      'System design validation from multiple specialist perspectives (performance, security, ops, cost, maintainability).',
    tier: 2,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  'grant-panel': {
    name: 'grant-panel',
    description:
      'Comparative prioritization under resource constraints. Reviewers score independently, panel calibrates and allocates.',
    tier: 3,
    inputSchema: {
      type: 'object',
      properties: {
        proposals: {
          type: 'string',
          description: 'JSON array of proposals or single proposal text',
        },
  ...
  'intelligence-analysis': {
    ...
    description:
      'Diagnostic reasoning via competing hypotheses (CIA method). Generate hypotheses, evaluate evidence, rank by likelihood.',
    tier: 3,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  delphi: {
    name: 'delphi',
    description:
      'Expert consensus building through iterative anonymous rounds. Experts refine estimates based on group feedback.',
    tier: 3,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  'design-critique': {
    ...
    description:
      'Structured design feedback. Peers and stakeholders provide categorized feedback, facilitator synthesizes.',
    tier: 3,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  'consensus-circle': {
    ...
    description:
      'Quaker-style consensus without voting. All voices heard, blocking concerns addressed, unity emerges.',
    tier: 3,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  'differential-diagnosis': {
    ...
    description:
      'Systematic diagnostic reasoning. Generate differentials, recommend tests, synthesize final diagnosis.',
    tier: 4,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  socratic: {
    name: 'socratic',
    description:
      'Assumption testing through systematic questioning. Socrates asks probing questions, respondent refines understanding.',
    tier: 4,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  swot: {
    name: 'swot',
    description:
      'Strategic situational assessment. Internal analyst (S/W), external analyst (O/T), strategist synthesizes.',
    tier: 4,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  'tumor-board': {
    name: 'tumor-board',
    description:
      'Multi-specialist consensus for complex decisions. Specialists from different domains contribute, chair synthesizes recommendation.',
    tier: 4,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  parliamentary: {
    name: 'parliamentary',
    description:
      'Adversarial policy discussion with formal debate structure. Government/opposition speeches, backbench contributions, vote.',
    tier: 4,
    inputSchema: {
      type: 'object',
      properties: {
